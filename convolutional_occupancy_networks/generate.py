...
parser.add_argument('--unitsize', type=float, default=0.002)
parser.add_argument('--queryvolsize', type=int, default=90)
...
cfg['data']['unit_size']=args.unitsize
cfg['data']['query_vol_size']=args.queryvolsize
cfg['generation']['resolution_0']=args.resolution
...
# Generator
generator = config.get_generator(torch.compile(model), cfg, device=device)
